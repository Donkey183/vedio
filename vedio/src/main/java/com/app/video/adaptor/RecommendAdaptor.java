...
//    private List<VideoData.Video> mVideoList;
//
...
//    }
//
//    public void showRecommendView(List<VideoData.Video> videoDataList) {
...
//    }
//
//    private VideoData.Video getItem(int position) {
//        return mVideoList.get(position);
//    }
//
//    private List<String> getBannerImageUrlList() {
//        List<String> urlList = new ArrayList<>();
//        for (VideoData.Video video : mVideoList) {
...
//
//        holder.video_name.setText(getItem(position).setDname());
//        holder.video_type.setText(mVideoList.get(position).getType());
//        Glide.with(mContext)
//                .load(mVideoList.get(position).getImageurl())
