...
public class Constants {
    ...
    public static Config purple_config = new Config(PURPLE,"紫钻区",R.drawable.zuanshi,R.drawable.zuanshi2,"蓝钻区",R.drawable.zuanshi,R.drawable.zuanshi2,vip_blue,null,R.drawable.pay4);
    public static Config blue_config = new Config(BLUE,"蓝钻区",R.drawable.zuanshi,R.drawable.zuanshi2,"皇冠区",R.drawable.crown1,R.drawable.crown2,vip_king,null,R.drawable.pay4);
    public static Config red_config = new Config(RED,"蓝钻区",R.drawable.zuanshi,R.drawable.zuanshi2,"皇冠区",R.drawable.crown1,R.drawable.crown2,null,null,R.drawable.pay4);
    public static Config crown_config = new Config(CROWN,"蓝钻区",R.drawable.black,R.drawable.black2,"皇冠区",R.drawable.crown1,R.drawable.crown2,vip_red,null,R.drawable.pay4);
