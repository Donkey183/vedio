...
public class Constants {
    ...
    public static Config nomor_config = new Config(NORMAL, "体验区", R.drawable.home, R.drawable.home2, "黄金区", R.drawable.vip, R.drawable.vip2, vip_gold, vip_diamond1, R.drawable.pay1, 30, 3615);
