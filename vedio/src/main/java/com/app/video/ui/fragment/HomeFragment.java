...
public class HomeFragment extends android.app.Fragment {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> implements View.OnClickListener
    {
        ...
        public void onBindViewHolder( final MyViewHolder holder, int position)
        {
            ...
            Glide.with(HomeFragment.this).load(videoList.get(position).getImageurl()).placeholder(R.mipmap.ic_launcher).error(R.mipmap.ic_launcher).into(holder.video_img);
