...
public class WindowUtil {
    ...
    private static boolean shouldIgnore(View view) {
        ...
        if (tag instanceof String) {
            ...
            return "ignore".equals(tagString);
        }
        return false;
    }
    ...
    public static boolean setWidth(View view, int designedWidthResId) {
        float designedWidth = ResourcesHelper.getDimension(designedWidthResId);
    ...
    public static boolean setHeight(View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = ResourcesHelper.getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
        ...
        params.height = (int) (designedHeight * SCALE_RATIO);// yhy add
        view.setLayoutParams(params);
        return true;
    }
    ...
    public static boolean setTextSize(TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize = ResourcesHelper.getDimension(designedTextSizeResId);
     ...
     * @return
     */
    public static boolean setMarginLeftRes(View view, int resId) {
        return setMarginLeft(view, (int) computeScaledDimenByHorizontalRatio(resId));
    }
    ...
    public static int getWindowWidth() {
        ...
        dm = ResourcesHelper.getDisplayMetrics();
        if (dm == null)
            return 0;
    ...
    public static int computeScaledVerticalSize(int size) {
        return (int) (size * SCALE_RATIO_VERTICAL);
    }
    ...
    public static boolean isLandscape() {
        return ResourcesHelper.getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static void computeWindowRotation() {
        WindowManager windowManager = (WindowManager) MFBaseApplication.getInstance().getSystemService(Context.WINDOW_SERVICE);
